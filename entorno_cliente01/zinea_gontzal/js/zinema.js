...
function EleccionPelicula() {
    ...
    for (let i = 0; i < salasPeli.length; i++) {
        do {
        ...
        divPelis[i].setAttribute("id", numRandom);
        divPelis[i].setAttribute("data-id", i);
        salasPeli[i].setAttribute("id", numRandom);
        salasPeli[i].firstChild.setAttribute("src", "IMG/" + numRandom + ".jpg");
    }
